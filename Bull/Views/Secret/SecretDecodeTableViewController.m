//
//  SecretDecodeTableViewController.m
//  Bull
//
...
@interface SecretDecodeTableViewController ()
@property (weak, nonatomic) IBOutlet UITextField *SecertCode;
@property (weak, nonatomic) IBOutlet UIButton *forgotSecertCode;
@end

@implementation SecretDecodeTableViewController
